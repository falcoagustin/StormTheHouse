...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/dust.png");
		loadFile("assets/explosion.png");
		loadFile("assets/hero.png");
		loadBinary("assets/mapCSV_map2_specials.csv");
		loadBinary("assets/mapCSV_map2_tiles.csv");
		loadBinary("assets/openfl.svg");
		loadFile("assets/tiles.png");
