...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		...
		add("assets/dust.png", IMAGE);
		add("assets/explosion.png", IMAGE);
		add("assets/hero.png", IMAGE);
		add("assets/mapCSV_map2_specials.csv", TEXT);
		add("assets/mapCSV_map2_tiles.csv", TEXT);
		add("assets/openfl.svg", TEXT);
		add("assets/tiles.png", IMAGE);
		//
	}
